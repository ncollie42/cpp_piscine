...
{
	std::cout << this->_name << " ranged attacked " << target << " for " << _range_damage << " damage!" << std::endl;
...
{
	std::cout << this->_name << " mele attacked " << target << " for " << _mele_damage << " damage!" << std::endl;
	return _mele_damage;
}
...
unsigned int FragTrap::vaulthunter_dot_exe(std::string const &target) const
{
	...
	std::cout << this->_name << " used 'vaulthunter.exe' " << target << " for " << _mele_damage << " damage!\n"
